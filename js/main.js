...
sending.addEventListener("click", function(){
    ...
    if ( (isNaN(yourAge) == true)) {
        ...
        if (yourAge < 18){
            ...
            message = "Abbiamo confrontato i prezzi ch esi trovano su siti di viaggi è questo e il costo medio a biglietto, essendo minorenne ha diritto allo sconto del 15% sul prezzo del biglietto: ";
            document.getElementById("ticket-price").innerHTML =  message +  price.toFixed(2) + "€";
        } else if (yourAge > 65) {
            price = normalRunning - normalRunning * 35 / 100;
            message = "Abbiamo confrontato i prezzi ch esi trovano su siti di viaggi è questo e il costo medio a biglietto, essendo over 65 ha diritto allo sconto del 35% sul prezzo del biglietto: ";
            document.getElementById("ticket-price").innerHTML =  message +  price.toFixed(2) + "€";
        } else {
            message = "Abbiamo confrontato i prezzi ch esi trovano su siti di viaggii è questo e il costo medio a biglietto è: "
